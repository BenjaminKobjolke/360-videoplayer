// Initialize Video.js player with VR plugin
const player = videojs('player');

player.ready(() => {
    // Initialize VR plugin with 360 video settings
    player.vr({
        projection: '360',
        motionControls: false  // Use mouse/touch controls instead of device motion
    });

    console.log('360° Video Player initialized');
    console.log('Drag with mouse to look around');
});
